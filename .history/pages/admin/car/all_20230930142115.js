...
const AllCarPage = () => {
  ...
  const handleSubmit = async (values) => {
      ...
      formData.append('passengers_number', parseInt(values.passengers_number));
      formData.append('wifi', values.wifi ? 1 : 0);
      formData.append('bags_count', parseInt(values.bags_count));
      ...
      dispatch(updateCar.request({id:editedCar.id, values:{...updatedCarData}}));

...
const AllStaffPage = () => {
  ...
  const handleUpdateStaff = (values) => {
    ...
    formData.append('fullname','dasdasdsadsa');
    formData.append('avatar',avatarFile);

    dispatch(updateStaff.request({id: editingStaff.id, formData:{...values, avatarFile}})); // Dispatch the updateStaff action with the new fullname

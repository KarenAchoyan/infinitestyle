...
const CreateStaffPage = () => {
  ...
  function isImageType(file) {
    return file.type === 'image/jpeg' || file.type === 'image/jpg' || file.type === 'image/jpg';
  }
      ...
      <Card title="Create Staff">
        <Form form={form} layout="vertical" onFinish={handleSubmit}>
          ...
          >
           ...
           {avatarPreview && 
             <button style={{position:'absolute', right:'0px'}} onClick={clearFile} type='button'>Remove</button>
            }
            <Upload
                accept=".jpg,.jpeg,.png"

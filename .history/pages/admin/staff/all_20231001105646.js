...
const AllStaffPage = () => {
  ...
  const handleUpdateStaff = (values) => {
    ...
    formData.append('avatar', avatarFile); // Add other fields as needed
    // formData.append('avatar', values.); // Add the avatar file

    dispatch(updateStaff.request(formData)); // Dispatch the updateStaff action with the new fullname

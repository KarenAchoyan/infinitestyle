...
const AllStaffPage = () => {
  ...
  const handleUpdateStaff = (values) => {
    ...
    dispatch(updateStaff.request({id: editingStaff.id, formData:{...values, avatar:avatarFile.file}})); // Dispatch the updateStaff action with the new fullname
    ...
    <Navbar>
      <div style={{ margin: '24px' }}>
        ...
        <Modal
          ...
          footer={null}
        >
          <Form form={editForm} layout="vertical" onSubmit={handleUpdateStaff}>
          <Form.Item
            name="avatar"
            label="Avatar"
          >

          ...
          <Sider trigger={null} collapsible collapsed={collapsed}>
              ...
              <Menu.Item key="1" icon={<UserOutlined />}>
                  ...
                  <SubMenu
                        ...
                        icon={<TeamOutlined />}
                        title="Review"
                        onTitleClick={() => handleSubMenuOpen('sub1')} // Handle submenu click
                    >
                        <Menu.Item
                        key="3"
                        onClick={() => handleSubMenuOpen('sub1')} // Handle menu item click
                        className={openKeys.includes('sub1') ? 'ant-menu-item-selected' : ''}
                        >

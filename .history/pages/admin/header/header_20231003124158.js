          ...
          <Sider trigger={null} collapsible collapsed={collapsed}>
              ...
              <Menu.Item key="1" icon={<UserOutlined />}>
                  ...
                  <SubMenu
                        ...
                        icon={<TeamOutlined />}
                        title="Review"
                        onTitleClick={() => handleSubMenuOpen('review')} // Handle submenu click
                    >
                        <Menu.Item
                        key="3"
                        onClick={() => handleSubMenuOpen('review')} // Handle menu item click
                        className={openKeys.includes('review') ? 'ant-menu-item-selected' : ''}
                        >

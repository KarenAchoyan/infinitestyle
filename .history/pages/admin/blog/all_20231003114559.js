...
const AllBlogPage = () => {
  ...
  const handleEditFormSubmit = (values) => {
    // Update the blog entry with the edited title (you can update other fields as needed)
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'avatar',
      render:(_,blog)=>(
        <img src={base+"/"+blog.avatar} style={{width:'150px'}} alt=""/>
      )
    },
    {
      title: 'Actions',
    ...
    <Navbar>
      ...
      >
        <Form
          ...
          initialValues={{ title: selectedBlog?.title || '' }}
        >
          <Form.Item
            name="title"
            label="Title"
